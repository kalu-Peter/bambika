  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl animate-fade-up">
        <p className="text-sm md:text-base tracking-[0.2em] italic mb-4 text-amber-400 font-body font-medium">
          Kujibamba ni everyday
        </p>
        ...
        <p className="text-base md:text-lg mb-8 text-stone-300 font-light max-w-xl mx-auto font-body">
          Bambika Designs — clothing, shoes, and bags curated for those who move
          different.
        </p>
        <a
          href="#collection"
